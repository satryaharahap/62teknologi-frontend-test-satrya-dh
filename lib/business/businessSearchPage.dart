...
class businessSearchPage extends StatefulWidget {
  const businessSearchPage({Key? key, this.search}) : super(key: key);
  final String? search;
  @override
  _businessPageState createState() => _businessPageState();
}

class _businessPageState extends State<businessSearchPage>{
  ...
  void initial() async {
    searchquery = widget.search.toString();
  ...
  Future getLoadMore(int offset) async {
    ...
    var url;
    url = '${MainUrl}search?term='+searchquery+'&location='+searchlocation+latlong+sortbyshow+searchdistanceshow+opennowshow+searchpricesshow+'&offset=${offset}';
  ...
  Future getBusiness() async {
    ...
    var url;
    url = '${MainUrl}search?term='+searchquery+'&location='+searchlocation+latlong+sortbyshow+searchdistanceshow+opennowshow+searchpricesshow;
          ...
          children: <Widget>[
            ...
            Expanded(
              child: Padding(
                padding: const EdgeInsets.only(left: 8.0),
                child: Text(
                  toBeginningOfSentenceCase(searchquery),
                  style: TextStyle(
